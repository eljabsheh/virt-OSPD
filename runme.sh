...
#  ansible-playbook -i inventories/virt-env-ospd/hosts  playbooks/virt-env-ospd/vco.yml --tags virt-env-ospd-hypervisor,virt-env-ospd-undercloud,virt-env-ospd-templates
